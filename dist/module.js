System.register(["app/plugins/sdk", "lodash", "moment", "angular", "jquery", "./lib/plotly.min"], function (exports_1, context_1) {
    "use strict";
        ...
        execute: function () {
            PlotlyPanelCtrl = (function (_super) {
                ...
                PlotlyPanelCtrl.prototype.onInitEditMode = function () {
                    ...
                    this.axis = [
                        { disp: 'X Axis', idx: 1, config: cfg.layout.xaxis, metric: function (name) { if (name) {
                                cfg.mapping.x = name;
                            } return cfg.mapping.x; } },
                        { disp: 'Y Axis', idx: 2, config: cfg.layout.yaxis, metric: function (name) { if (name) {
                                cfg.mapping.y = name;
                            } return cfg.mapping.y; } },
                        { disp: 'Z Axis', idx: 3, config: cfg.layout.yaxis, metric: function (name) { if (name) {
                                cfg.mapping.z = name;
